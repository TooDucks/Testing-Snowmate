...
def main():
    ...
    # print(f'p_id {config["PROJECT_ID"]}\n c_id {config["SNOWMATE_CLIENT_ID"]}\n c_sc {config["SNOWMATE_CLIENT_SECRET"]}')
    snowmate_collector.start(
        sanity=True,
        project_path = ".",
        project_id = config["PROJECT_ID"],
        client_id = config["SNOWMATE_CLIENT_ID"],
        secret_key = config["SNOWMATE_CLIENT_SECRET"]
    )
